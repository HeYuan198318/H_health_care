...
public class MessageConstant {
    ...
    public static final String ADD_USER_FAIL = "添加用户数据失败";
    public static final String ADD_USER_SUCCESS = "添加用户数据成功";
    public static final String QUERY_USER_FAIL = "查询用户数据失败";
    public static final String QUERY_USER_SUCCESS = "查询用户数据成功";
